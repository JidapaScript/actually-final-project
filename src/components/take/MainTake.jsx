export default function MainTake(){
    return (
        <div className="take-for flex flex-column justify-items-end w-3/4 space-y-300 bg-transparent border-white border-1">
            <div className="take-post flex-row justify-start space-x-34">
                <div className="profile flex-row justify-start space-x-20">
                    ...
                    <div className="take-content flex flex-column justify-start space-y-36 w-[785px]">
                ...
                <div className="flex flex-row justify-end pace-x-14">
                    <a href="#"> <img className="icon-save" src="/icons/bookmark.svg"/> </a>
                    <a href="#"> <img className="icon-share" src="/icons/ios_share.svg"/> </a>
                </div>
            </div>
            <div className="take-engagement flex flex-row justify-end space-x-8">
