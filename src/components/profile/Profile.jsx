export default function Profile(){
    return (
        <div className="flex flex-column justify-start items-center p-6 bg-transparent border-white border-2">
            ...
            <div className="profile-name-img flex flex-column justify-between space-y-6">
                <img className="profile-img-lg" src="/profiles/profile_lg.png"/>
                <h3 className="text-2xl text-white font-semibold">Tom Jerry</h3>
            </div>
            <div className="profile-content flex flex-column justify-start space-y-3.5">
                <div className="followers flex-row justify-start space-x-4">
