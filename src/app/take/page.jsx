...
export default function Take() {
  return (
    <div className="flex-column justify-start min-w-full min-h-full">
      ...
      <div className="flex-row justify-between mx-9 my-6">
        <title className="heading flex-column justify-start space-y-1">
        ...
        <tags className="flex-row justify-end space-x-0.5">
      ...
      <hr className="divider-line w-full h-px mt-3 bg-white"/>
      <div className="flex-row justify-between space-x-9 mx-9 mt-4 mb-10">
        <MainTake />
        <OppTake />
      </div>
    </div>
